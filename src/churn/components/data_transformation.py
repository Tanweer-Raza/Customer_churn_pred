...
class DataTransformation:
    ...
    def get_data_transformation_object(self) -> Pipeline:
        try:
            ...
            categorical_col.remove('Customer Status')
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        try:
            ...
            save_object( self.data_transformation_config.data_transforamtion_object_dir_name, preprocessing_obj,)
            logging.info("Completed saving numpy data")

            logging.info("started DataTransformationArtifact ")
            data_transformation_artifact = DataTransformationArtifact(
                transformed_object_file_path=self.data_transformation_config.data_transforamtion_object_dir_name,
